    ...
    <%
            ...
            <div class="container text-center p-0">
                <div class="row p-5">
                    ...
                    <div class="col-12 col-sm-4 col-md-6 col-lg-12 text-secondary-emphasi bg-body-tertiary rounded-2"
                    style="max-width: 40%;">
                    ...
                    <div
                        class="sidebar-brand-text fs-4 p-3 mx-3">Bienvenid@</sup></div>
                    </a>
                    <br>
                      ...
                      <div class="col-12">
                        <nav class="navbar navbar-expand-lg bg-body-tertiary rounded-1">
                            <div class="container-fluid">
                                <small class="text-primary-emphasis">Saldo Disponible</small>
                                <small class="text-primary-emphasis"> $ <%=usuario.getSaldo() %></small>
                                <ul class="navbar-nav ms-auto">
                        
                                    <li class="nav-item dropdown text-primary-emphasis fs-5">
                                        <a class="nav-link dropdown-toggle btn-secondary" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                           <b><%=usuario.getNombreApellido() %></b> 
                      ...
                      <div class="col-12">
                        ...
                        <div class="border-left-secondary">
                            <div class="card-body">
                                ...
                                <ul type="none">
                                <li class="text-primary-emphasis fs-4">Usuario en Linea: </li>
                                <br>
                                     <li class="text-primary-emphasis fs-5"><b>Correo Electrónico: </b><%=usuario.getIdEmail() %></li>
                                      <li class="text-primary-emphasis fs-5"><b>Número de Cuenta: </b><%=usuario.getNumeroCuenta() %></li>
                                        <li class="text-primary-emphasis fs-5"><b>Fecha de Registro: </b><%=usuario.getFechaRegistro() %></li>
